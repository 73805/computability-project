"""
3SAT Truth Assignment Verifier. This method takes a dictionary of truth
assignment and a set of clauses as input, and checks whether the clauses
are satisified in 3SAT terms.
...
# Normal 3SAT Satisfaction tester
def verifier_3SAT(literals, clauses):
